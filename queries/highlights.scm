...
; Definer macros share defun styling.
(list_lit
  . [(sym_lit) (package_lit)] @keyword.function
  (#match? @keyword.function "(?i)^(cl:)?(defpackage|defparameter|defstruct|defclass|defmethod|in-package)$"))

; Keyword literals (:use, :export, …). Style kwd_lit; keep bare "." as punctuation.special.
(kwd_lit) @string.special.symbol
(kwd_symbol) @string.special.symbol
